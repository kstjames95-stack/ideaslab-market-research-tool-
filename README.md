...
Demo walkthrough: [add Loom link]
...
Before this goes out to 80,000 followers, I built rate limiting: one report per email address. I'll leave the implementation out of this writeup.
